...
export default function Sidebar({user}) {
  ...
  return (
    ...
    <nav className="fixed left-0 top-0 h-screen text-white flex flex-col overflow-hidden">
        {/* Header */}
        <div
      ...
      >
        ...
        <button
            onClick={() => handleClickOption("/login")}
            className="absolute right-4 cursor-pointer flex items-center justify-center gap-1"
        >
